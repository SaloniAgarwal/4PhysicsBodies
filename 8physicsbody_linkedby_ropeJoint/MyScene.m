//
//  MyScene.m
//  8physicsbody_linkedby_ropeJoint
//
//  Created by PRATIK on 2/22/14.
//  Copyright (c) 2014 PRATIK. All rights reserved.
//
...
@property SKPhysicsJointPin* mypin;
...
-(void) activateJointRope{
   ...
   // [self.physicsWorld addJoint:_myRopeJoint6];
    ...
    _mypin = [SKPhysicsJointPin jointWithBodyA:_mySquare7.physicsBody bodyB:_mySquare8.physicsBody anchor:_mySquare7.position];
    [self.physicsWorld addJoint:_mypin];
...
-(void) spawnSquares{
    ...
    _mySquare5 =[[SKSpriteNode alloc]initWithColor:[SKColor blackColor] size:CGSizeMake(50, 50)];
    _mySquare6 =[[SKSpriteNode alloc]initWithColor:[SKColor greenColor] size:CGSizeMake(50, 50)];
    _mySquare7 =[[SKSpriteNode alloc]initWithColor:[SKColor blueColor] size:CGSizeMake(50, 50)];
    ...
    [_mySquare5 setPosition:CGPointMake(self.size.width/2.2, self.size.height/2.5)];
